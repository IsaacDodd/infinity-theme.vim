"=====================================================================
"
" ______   __  __  ____    ______   __  __  ______  ______  __    __
...
"
"
" INFINITY ∞ ColorScheme
" ==============================
" Maintained by Isaac M. E. Dodd
"	Originally based on the now-deprecated 'Tomorrow' theme by Chris Kempson (https://chriskempson.com)
"	(Hex color conversion functions based on the theme "Desert256")
"	Some additions from fruchtig (https://github.com/schickele/vim-fruchtig) & SpaceVim (https://spacevim.org)

let g:colors_name = "InfinityNight"
...
" Default GUI Colors
let s:foreground = "c5c8c6" " #C5C8C6
let s:background = "1d1f21"	" #1D1F21
let s:selection = "373b41"	" #373B41
let s:line = "282a2e"		" #282A2E
let s:comment = "969896"	" #969896
let s:red = "cc6666"		" #CC6666
let s:orange = "de935f"		" #DE935F
let s:yellow = "f0c674"		" #F0C674
let s:green = "b5bd68"		" #B5BD68
let s:aqua = "8abeb7"		" #8ABEB7
let s:blue = "81a2be"		" #81A2BE
let s:purple = "b294bb"		" #B294BB
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	if version >= 700
		...
		call <SID>X("CursorLineNr", s:red, s:line, "bold")
...
" vim: set ff=unix ts=4 sw=4 tw=500 noet :
